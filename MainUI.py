...
class Ui_Face_Recognition_window(object):
    def setupUi(self, Face_Recognition_window):
        ...
        self.widget.setGeometry(QtCore.QRect(30, 40, 798, 557))
        ...
        self.lab_frame = QtWidgets.QLabel(self.widget)
        ...
        self.comboBox_selectLabel = QtWidgets.QComboBox(self.widget)
        ...
        self.btn_addNewFace = QtWidgets.QPushButton(self.widget)
        ...
        self.btn_takePhoto = QtWidgets.QPushButton(self.widget)
        ...
        self.btn_recogniton = QtWidgets.QPushButton(self.widget)
        ...
        self.btn_delFace = QtWidgets.QPushButton(self.widget)
