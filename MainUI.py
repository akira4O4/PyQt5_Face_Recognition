...
class Ui_Face_Recognition_window(object):
    def setupUi(self, Face_Recognition_window):
        ...
        self.comboBox_selectId = QtWidgets.QComboBox(self.layoutWidget)
        self.comboBox_selectId.setObjectName("comboBox_selectId")
        self.verticalLayout_3.addWidget(self.comboBox_selectId)
        self.comboBox_CheckTable = QtWidgets.QComboBox(self.layoutWidget)
        self.comboBox_CheckTable.setObjectName("comboBox_CheckTable")
        self.verticalLayout_3.addWidget(self.comboBox_CheckTable)
        ...
        self.actiona = QtWidgets.QAction(Face_Recognition_window)
        self.actiona.setObjectName("actiona")
        self.actionb = QtWidgets.QAction(Face_Recognition_window)
    ...
    def retranslateUi(self, Face_Recognition_window):
        ...
        self.actiona.setText(_translate("Face_Recognition_window", "添加考勤表"))
        self.actionb.setText(_translate("Face_Recognition_window", "删除考勤表"))
