...
class Ui_SqliteMainWindow(object):
    def setupUi(self, SqliteMainWindow):
        ...
        SqliteMainWindow.resize(1020, 622)
        ...
        self.scrollAreaWidgetContents.setGeometry(QtCore.QRect(0, 0, 207, 431))
        ...
        self.scrollAreaWidgetContents_2.setGeometry(QtCore.QRect(0, 0, 204, 346))
    ...
    def retranslateUi(self, SqliteMainWindow):
        ...
        self.pushButton_update.setText(_translate("SqliteMainWindow", "更新"))
