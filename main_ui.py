...
class Ui_Face_Recognition_window(object):
    def setupUi(self, Face_Recognition_window):
        ...
        Face_Recognition_window.resize(832, 662)
        ...
        self.layoutWidget.setGeometry(QtCore.QRect(10, 10, 808, 604))
        ...
        self.line_faceNum = QtWidgets.QLineEdit(self.layoutWidget)
        self.line_faceNum.setEnabled(False)
        font = QtGui.QFont()
        font.setPointSize(16)
        self.line_faceNum.setFont(font)
        self.line_faceNum.setObjectName("line_faceNum")
        self.verticalLayout.addWidget(self.line_faceNum)
    ...
    def retranslateUi(self, Face_Recognition_window):
        ...
        self.btn_addFace.setText(_translate("Face_Recognition_window", "添加人脸文件夹"))
        self.btn_train.setText(_translate("Face_Recognition_window", "训练模型"))
        self.btn_takePhoto.setText(_translate("Face_Recognition_window", "录入人脸信息"))
